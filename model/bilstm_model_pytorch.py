...
class SentimentLSTM(nn.Module,BaseModel):
    """
    ...
    def build(cls,TrainData, ValidationData,embedding_type , embedding_dim, hidden_dim, output_dim, batch_size, n_layers,dropout_prob,Device):
      cls.model = SentimentLSTM(TrainData, ValidationData,embedding_type,embedding_dim, hidden_dim, output_dim, batch_size, n_layers,dropout_prob,Device)
      return cls.model
